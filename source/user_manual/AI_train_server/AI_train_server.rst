...
This section outlines the steps to execute on the AI Training Server after you have successfully set up and logged in.

Steps to Run the AI Training
============================
